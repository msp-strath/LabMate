...
%
We have already shown a simple example where LabMate does not merely check but rather generates boilerplate code using its types as specification.
%
...
%
There is so much to learn outside our ivory tower!
