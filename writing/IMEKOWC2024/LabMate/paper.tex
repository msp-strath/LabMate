...
\end{enumerate}
In the short term, LabMate can get by with a hard-coded table of which types admit addition, but more flexible and general approaches to operator overloading (e.g., Haskell's `type classes'~\cite{wadler.blott}) are readily adoptable in due course.
